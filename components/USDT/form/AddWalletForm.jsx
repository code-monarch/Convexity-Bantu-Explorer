...
import { addWallet } from "../../../app/xbn/xbnwalletSlice";
    ...
    <div className={`${style.container} ${openModal ? "block" : "hidden"}`}>
      <div className='flex flex-col items-center'>
        <form
          ...
          <div className='mb-2'>
            <label
              className='block text-[#f9690c] text-sm font-bold mb-2'
              htmlFor='walletId'>
              Wallet public key
            </label>
            <input
              className='shadow appearance-none border focus:border-[#c5692c] rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline'
              type='text'
              name='walletKey'
              placeholder='TV6MuMXfmLbBqPZvBHdwFsDnQeVfnmiuSi'
          ...
          <div className='mb-4'>
            ...
            <input
              className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:border-[#c5692c] focus:outline-none focus:shadow-outline'
              name='customName'
              type='text'
              placeholder='Mr. Deji'
          ...
          <div className='flex items-center justify-between'>
            <button
              className='w-full bg-[#f9690c] hover:border-[#f9690c] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'
              type='submit'>
              Save Wallet
            </button>
          </div>
